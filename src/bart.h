...
public:
  ...
  void setm(size_t m);
  void setdata(size_t p, size_t n, size_t nunique, double *x, double *y, double *xunique,
               Rcpp::NumericVector s1, Rcpp::NumericVector s2,
               Rcpp::NumericVector dat_size, size_t nc=100);
  void setdata(size_t p, size_t n, size_t nunique, double *x, double *y, double *xunique,
               int* nc,Rcpp::NumericVector s1, Rcpp::NumericVector s2,
